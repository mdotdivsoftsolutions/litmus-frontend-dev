...
import { ArrowLeft, CheckCircle2, Beaker, FileText, Plus, Trash2, Upload, ImageIcon, Loader2, HelpCircle } from "lucide-react";
...
"px-6 py-3 text-sm font-medium transition-colors border-b-2 outline-none",
 ...
 <Input name="testName"value={formData.testName} onChange={handleChange} placeholder="e.g. Fat Content Analysis"className="bg-background/50"/>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                      ...
                      <Tooltip delayDuration={200}>
                        ...
                        <TooltipContent side="top" className="max-w-xs text-xs p-3 space-y-1.5 bg-slate-900 text-slate-50 border-slate-800 shadow-xl">
                          ...
                          <p className="text-emerald-400 font-medium pt-1.5 border-t border-slate-700/80 text-[11px] leading-tight">
                            ⚙️ You can manage and create custom test classifications in <strong>Admin Settings → Master Catalog</strong>.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  ...
                  <Select 
                    value={formData.metadata.type || undefined} 
                    onValueChange={(val) => handleMetadataChange("type", val)}
                  >
                    ...
                    <SelectContent>
                      {Array.from(
                        new Set([
                          ...
                          "Microbiological",
                          "Physical",
                          ...(testTypesData?.data?.map((t: any) => t.name) || []),
 ...
 <Button onClick={handleSave} disabled={saveMutation.isPending} className="w-40 bg-primary hover:bg-primary-deep text-white shadow-md shadow-primary/20 font-bold">
