...
export const CategoryStrip = ({ selectedCategory, setSelectedCategory }: CategoryStripProps) => {
  const categories = [
    ...
    { name: "Spices", img: "https://images.unsplash.com/photo-1599481238640-4c1288720d7a?q=80&w=400", isLink: true, href: "/tests?category=Spices" },
    ...
    { name: "Processed Foods", img: "https://images.unsplash.com/photo-1556910103-1c02745aae4d?q=80&w=400", isLink: true, href: "/tests?category=Processed%20Foods" },
    { name: "Snacks", img: "https://images.unsplash.com/photo-1541604193435-2258a91e1d68?q=80&w=400", isLink: true, href: "/tests?category=Snacks" },
    ...
    { name: "Nuts & Seeds", img: "https://images.unsplash.com/photo-1599598425947-3300262066ed?q=80&w=400", isLink: true, href: "/tests?category=Nuts%20%26%20Seeds" },
